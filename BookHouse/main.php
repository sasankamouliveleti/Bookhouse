...
<head>
    ...
    <link rel="stylesheet" href="pre.js"/>
...
<p class=" center" ><b>Contact us:bookhouse@gmail.com</b></p>
<h5 class="center"><i>Sign Up Now !!! for for various publications.</i><h5>
<div class="container">
    <div class="section">
...
<footer class="page-footer teal darken-4">
    <div class="container">
        <div class="row">
            <div class="col l6 s12">
                ...
                <p class="grey-text text-lighten-4">Any</p>
            </div>
    ...
    <div class="footer-copyright">
        <div class="container">
             <a class="teal darken-4" href="pre.php">BookHouse</a>
        </div>
    </div>
</footer>
